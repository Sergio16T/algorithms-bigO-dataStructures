const removeNthNodeFromEnd = require('../algorithms/LinkedLists/removeNthNodeFromEndOfList');
...
const linkedList = new ListNode(1, new ListNode(2, null));
const linkedListCase1 = new ListNode(1, null);

const linkedList2 = new ListNode(1, new ListNode(2, new ListNode(3, new ListNode(4, null))));
